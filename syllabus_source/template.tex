...
\newcommand{\syllabusfooter}{%
  ...
  Generated $created$%
  \hspace{1.5em}\textbullet\hspace{1.5em}%
  \href{https://doethics.fun/syllabus/}{HTML version}%
  \hspace{1.5em}\textbullet\hspace{1.5em}%
  \href{https://doethics.fun/}{Course site}%
}
\fancyfoot[L]{\syllabusfooter}
\fancyfoot[R]{\footnotesize\color{footergray}\thepage}
